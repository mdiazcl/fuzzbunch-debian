...
class SMTPChannel(asynchat.async_chat):
    ...
    def smtp_MAIL(self, arg):
        ...
        if arg:
            address = self.__getaddr('FROM:', arg) if 1 else None
            address or self.push('501 Syntax: MAIL FROM:<address>')
            return
        else:
            if self.__mailfrom:
    ...
    def smtp_RCPT(self, arg):
        ...
        if not self.__mailfrom:
            ...
            if arg:
                address = self.__getaddr('TO:', arg) if 1 else None
                address or self.push('501 Syntax: RCPT TO: <address>')
                return
